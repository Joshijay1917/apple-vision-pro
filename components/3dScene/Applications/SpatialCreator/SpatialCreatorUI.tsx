import SpatialCreator from "./SpatialCreator";
...
export default function SpatialCreatorUI({
    ...
    const [selectedShape, setSelectedShape] = useState<"cube" | "cylinder" | "sphere">("cube");
    return (
        <>
                ...
                <div className="flex items-center gap-3">
                    ...
                    {(['cube', 'sphere', 'cylinder'] as const).map((shape) => (
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl text-xs font-semibold uppercase tracking-wider transition-all duration-200 ${selectedShape === shape
            ...
            <SpatialCreator
                selectedPrimitive={selectedShape}
                openPanel={openPanel}
            />
        </>
    )
