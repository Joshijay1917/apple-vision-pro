...
//     </div>
      ...
      <div className="relative z-10 flex flex-col justify-between p-6 md:p-12 min-h-screen pointer-events-none">
        ...
        {/* Header Block */}
        <header className="max-w-xl bg-black/40 backdrop-blur-md p-6 rounded-2xl border border-white/10 pointer-events-auto">
        ...
        <section className="my-auto w-content bg-black/40 backdrop-blur-lg p-6 rounded-2xl border border-white/10 pointer-events-auto shadow-2xl">
        <h1 className="text-2xl md:text-3xl font-black tracking-tight mt-1">Explore other effects</h1>
        <div className='flex gap-4 w-full'>
          <button onClick={() => router.push('/effect1')} className='bg-orange-900/45 my-2 p-2 rounded-2xl'>Effect 1</button>
          <button onClick={() => router.push('/effect2')} className='bg-green-900/45 my-2 p-2 rounded-2xl'>Effect 2</button>
          <button onClick={() => router.push('/effect3')} className='bg-yellow-900/45 my-2 p-2 rounded-2xl'>Effect 3</button>
          <button onClick={() => router.push('/effect4')} className='bg-red-900/45 my-2 p-2 rounded-2xl'>Effect 4</button>
          <button onClick={() => router.push('/effect5')} className='bg-red-900/45 my-2 p-2 rounded-2xl'>Effect 5</button>
          <button onClick={() => router.push('/effect6')} className='bg-red-900/45 my-2 p-2 rounded-2xl'>Effect 6</button>
          <button onClick={() => router.push('/effect7')} className='bg-red-900/45 my-2 p-2 rounded-2xl'>Effect 7</button>
        </div>
        </section>
        </div>

        {/* Dynamic Spec Metric Card */}
        <section className="my-auto max-w-md bg-black/60 backdrop-blur-lg p-6 rounded-2xl border border-white/10 pointer-events-auto shadow-2xl">
        ...
        <footer className="w-full flex justify-center gap-4 mt-6 pointer-events-auto">
          <button
            onClick={() => setMode('2d')}
            className={`px-6 py-3 rounded-full font-bold text-sm tracking-wide transition-all shadow-lg ${
              mode === '2d'
